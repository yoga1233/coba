...
class AppStyle {
  static ThemeData appTheme(hexColor, splashColor) {
    return ThemeData(
      ...
      primaryColor: MaterialColor(hexColor, AppColors.color),
      primarySwatch: MaterialColor(hexColor, AppColors.color),
...
class TextStyles {
  ...
  static TextStyle get heading =>
      text.copyWith(fontWeight: FontWeights.semiBold, fontSize: 24.w);

  static TextStyle get title => text.copyWith(
  ...
  static TextStyle get subTitle =>
      text.copyWith(fontWeight: FontWeights.semiBold, fontSize: 16.w);

  static TextStyle get desc => text.copyWith(fontSize: 12.w);

  static TextStyle get regular => text.copyWith(fontSize: 14.w);
