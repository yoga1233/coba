    ...
    if (widget.inputStyle == InputStyle.box) {
      switch (tState) {
        case TextFieldState.focus:
          return _box(borderColor: AppColors.primaryColor);
      ...
      switch (tState) {
        case TextFieldState.focus:
          return _line(borderColor: AppColors.primaryColor);
        case TextFieldState.error:
      ...
      switch (tState) {
        case TextFieldState.focus:
          return _outline(borderColor: AppColors.primaryColor);
        case TextFieldState.error:
    ...
    return Column(
      ...
      children: [
        if (widget.label != null)
          Text(
            widget.label!,
            style: TextStyles.desc.copyWith(color: AppColors.primaryColor),
          ),
        Container(
